...
::::
:::: {.column width="50%"}
- `git restore [--worktree] <path>`: restore file in workdir from staging area
- `git restore --staged <path>`: restore file in staging area from repo
- `git restore --worktree --staged <path>`: restore file in workdir and staging area from repo
