...
:::: columns
::: {.column width="50%"}
![](figures/version_mess.png){.nostretch width="100%" fig-align="center"}
:::
::: {.column width="50%"}
...
## Git stores snapshots, not deltas. {.smaller}
:::: columns
::: {.column width="50%"}
...
- Commit: 
    - snapshot + reference of parent and other metadata
    - often represented as a diff
:::
::::
