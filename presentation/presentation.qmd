...
- `git switch <branchname>` instead of `git checkout <branchname>`
- `git switch -c <branchname>` instead of `git checkout -b <branchname>`
- `git restore <paths>` instead of `git checkout -- <paths>`
